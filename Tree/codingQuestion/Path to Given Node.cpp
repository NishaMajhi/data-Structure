/*
Problem Description  : Given a Binary Tree A containing N nodes.You need to find the path from Root to a given node B.
...
bool getPath(TreeNode *A,int t,vector<int> &ans){
    ...
    if(getPath(A->left,t,ans) || getPath(A->right,t,ans))
       return true;
